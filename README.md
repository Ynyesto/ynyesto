...
3. [Make NFTs with On-chain Metadata with Hardhat and Javascript](https://github.com/arynyestos/RoadToWeb3NftsOnchainMetadata): Another Solidity, Javascript and Hardhat project, in which we created fully on-chain, dynamic NFTs.
4. Create an NFT Gallery: Coming soon...
