...
| --------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| **ETHGlobal Bangkok**       | [Migrator](https://ethglobal.com/showcase/migrator-ethbelgrade-7x4pc)                      | Blockscout prize, Chainlink Best Use of CCIP ($4,000), Scroll Best Use of L1SLOAD 2nd place ($1,500) |
| **Vottun & DexTools**       | [DCA Bitcoin dApp](https://github.com/ynyesto/VottunDextoolsHackathon)                     | **1st prize**, later became BitChill                                                                 |
| **Block & Change**          | [Repo](https://github.com/ynyesto/BlockChangeHackathon)                                    | **Best social innovation**                                                                           |
| **Constellation Chainlink** | [Prompt Fighters](https://github.com/CarlosAlegreUr/Constellation-ChainlinkHackathon-2023) | Team project with [Devpost](https://devpost.com/software/prompt-fighters) submission                 |
...
- **Cyfrin Updraft Security Track**: [Smart Contract Security](https://updraft.cyfrin.io/courses/security) course and [Assembly & Formal Verification](https://updraft.cyfrin.io/courses/formal-verification) course.
...
### Uniswap Hooks Incubator workshop hooks

- [Points hook](https://github.com/ynyesto/UHI4-points-hook)
- [Gas price dynamic fees](https://github.com/ynyesto/UHI4-gas-price-dynamic-fees)
- [Limit orders](https://github.com/ynyesto/UHI4-limit-orders)
- [CSMM no-op hook](https://github.com/ynyesto/UHI4-csmm-noop-hook)
- [Swap and bridge to Optimism](https://github.com/ynyesto/UHI-swap-and-bridge-op)
